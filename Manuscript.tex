...
\begin{figure}
  \centering 
  \includegraphics[width=0.6\textwidth]{ip_PID}
...
\begin{figure}
  \centering 
  \includegraphics[width=0.6\textwidth]{ip_PID_actions}
...
\begin{figure}
\centering
\includegraphics[width=0.6\textwidth]{ip_RL.png}
...
\begin{figure}
\centering
\includegraphics[width=0.6\textwidth]{ip_RL_actions.png}
...
\begin{figure}
\centering
\includegraphics[width=.6\textwidth]{double_PID_actions.png}
\caption{Actions taken by the PID controller}
...
\begin{figure}
\centering
\includegraphics[width=.6\textwidth]{double_RL_actions.png}
\caption{Actions taken by the RL agent.}
